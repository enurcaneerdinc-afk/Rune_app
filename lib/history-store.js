...
export function getHistory() {
  // NOT: aynı milisaniyede birden fazla kayıt oluşabilir (art arda hızlı
  // çekimler). Eşit zaman damgalarında 0 dönmek, JS'in kararlı (stable)
  // sıralamasının, ekleme sırasını (unshift ile zaten en yeni en başta)
  // bozmadan korumasını sağlıyor.
